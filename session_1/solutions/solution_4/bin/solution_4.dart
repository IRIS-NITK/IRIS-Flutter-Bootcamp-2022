...
void main() {
  ...
  if(userType == 1){                                   //admin access
    ...
    List input = (stdin.readLineSync()!).split(' ');    //get the first two strings from input,exception not handled for 1 string
    ...
    if(branch == "cs"){                                 //implemented only for cs
...
class OpenElective{                                        //open elective class, contains static members only
...
class BranchElective extends OpenElective{          // branch electives, inheriting OpenElective class
