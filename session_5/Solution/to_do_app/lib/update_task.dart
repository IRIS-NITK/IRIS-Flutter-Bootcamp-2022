...
class Update_Tasks extends StatefulWidget {
  int position;
  Task TaskModel;

  // ignore: non_constant_identifier_names
  Update_Tasks({Key? key, required this.position, required this.TaskModel})
      : super(key: key);
...
class _Update_Tasks extends State<Update_Tasks> {
  ...
  void initState() {
    ...
    controllerdesc = TextEditingController(text: widget.TaskModel.desc);
    super.initState();
  }
          ...
          child: Column(
            ...
            children: <Widget>[
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      onTap: (){
                        setState(() {
                          widget.TaskModel.desc = controllerdesc!.text;
                        });
                      },
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: <Widget>[
                  const Text("TASK END DATE :",  style: TextStyle(fontSize: 15,fontFamily: "Philosopher Italic",fontWeight: FontWeight.bold)),
                  const SizedBox(width: 20),
                  Expanded(
                    child: TextFormField(
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: <Widget>[
                  const Text("TASK END TIME :",  style: TextStyle(fontSize: 15,fontFamily: "Philosopher Italic",fontWeight: FontWeight.bold)),
                  const SizedBox(width: 20),
                  Expanded(
                    child: TextFormField(
                      style: const TextStyle(
                      ...
                      onPressed: () async {
                        if (_formKey.currentState!.validate()) {
                          ...
                          if (getTaskdesc.isNotEmpty &
                            ...
                            box.putAt(widget.position,addTask);
                          }
